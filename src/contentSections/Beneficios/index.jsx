  ...
  return (
    <>
      <ul>
        ...
        <li>
          Espaço Científico: Explore mais de 30 pesquisas inovadoras, abrindo
          novas perspectivas e entendimentos no TEA.
        </li>

        <li>
          Expositores Internacionais: Conheça as últimas soluções e tecnologias
          de mais de 60 expositores, tanto do Brasil quanto do mundo.
        </li>
        ...
        <li>
          Espaço para Fotos e Autógrafos: Não perca a chance de interagir com
          palestrantes e convidados especiais.
        </li>

        <li>
          Pontos de Recarga de Celular: Fique sempre conectado e ativo durante o
          evento.
        </li>

        <li>
          Wi-Fi Exclusivo Brisanet: Acesso rápido e fácil à internet para todos
          os participantes.
        </li>
        ...
        <li>
          ...
          fisicamente? Assista ao evento ao vivo online e acesse as gravações
          por 24 meses.
        </li>
      ...
      <p>
        No Conect Autismo 2024, garantimos que todos os palestrantes, workshops,
        expositores e estudos de caso apresentados possuem embasamento
        científico rigoroso.
      </p>
    </>
  );
