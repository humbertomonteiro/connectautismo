...
export default function Versa() {
  return (
    <>
      <div>
        <p>
          Estamos orgulhosos em apresentar o 'Conect Autismo 2024', um evento
          pioneiro organizado pela Versa Consultoria e Eventos. Com nosso
          compromisso inabalável com qualidade e segurança, estamos definindo
          novos padrões no universo dos eventos.
        </p>
        <p>
          Na Versa, acreditamos que cada evento é uma oportunidade única de
          criar experiências memoráveis e impactantes. 'Conect Autismo 2024' não
        ...
        <p>
          ...
          evento, negócio ou produto. Junte-se a nós no 'Conect Autismo 2024' e
